...
public class RegresAPI {	
	 ...
	 RequestSpecification httpRequest = null;
      ...
      public  Logger logger;
	    ...
	    @Test(description = "GetSingleUserRequest")
	    @Story("GET Request of single user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Verify the details of single user of id-2")
	    ...
	    @Test(description = "GetSingleUserRequestc")
	    @Story("GET Request of single user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Get the response of single user of id-2")
	    ...
	    @Test(description = "GetListofusersc")
	    @Story("GET Request of all users")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Get the response of all users on page-2")
	    ...
	    @Story("GET Request of all users")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Verify the details of all users on page-2")
	    ...
	    @Test(description = "CreateuserRequestc")
	    @Story("POST Request of a user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Create the response of a user")
	    ...
	    @Test(description = "UpdateuserRequestc")
	    @Story("Update Request of user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Update and verify the details of a user")
	    ...
	    @Test(description = "UpdateuserRequest")
	    @Story("Update Request of user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Update the response of a user")
	    ...
	    @Test(description = "DeleteSingleUserRequest")
	    @Story("Delete Request of user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Delete the response of a user")
	    ...
	    @Test(description = "DeleteSingleUserRequestc")
	    @Story("Delete Request of user")
	    @Severity(SeverityLevel.NORMAL)
	    @Description("Test Description : Delete and verify the details of a user")
